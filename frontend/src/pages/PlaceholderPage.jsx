  ...
  return (
    <div className="px-5 py-12 lg:px-8">
      <section className="mx-auto max-w-2xl rounded-2xl border border-slate-200 bg-white p-8 text-center shadow-sm sm:p-12">
        ...
        <p className="mt-6 text-xs font-bold uppercase tracking-[0.16em] text-teal-700">Phase 2B</p>
        ...
        <div className="mt-7 rounded-xl border border-amber-200 bg-amber-50 px-4 py-3 text-sm font-bold text-amber-900">Coming in Phase 2B</div>
